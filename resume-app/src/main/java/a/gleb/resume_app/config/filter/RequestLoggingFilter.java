...
import static a.gleb.resume_app.constant.ResumeAppConstant.REQUESTOR;
import static a.gleb.resume_app.constant.ResumeAppConstant.TRACE_ID_RESPONSE_HEADER;

/**
 * Filter for logging incoming requests with user `login` in MDC.
 * Runs after security filter chain to capture authenticated user information.
 */
@Slf4j
@Component
